...
export const CardUpdate = ({ name = 'Programing', namefile = 'congnghe.png', id }) => {
    ...
    return (
        <>
            {isToast === 1 && <ToastSuccess message="Cập nhật chủ đề thành công" />}
            {isToast === 2 && <ToastError message="Cập nhật chủ đề thất bại" />}
...
const FormCreateOne = () => {
    ...
    return (
        <>
            {isToast === 1 && <ToastSuccess message="Tạo chủ đề thành công" />}
            {isToast === 2 && <ToastError message="Tạo chủ đề thất bại" />}
            <div className=" p-3 border border-primary-black bg-primary-grey mb-5">
                <>
                    <h3 className=" text-label-2 font-label-2 font-plusjakartasans text-primary-black mb-2">
                        Tên chủ đề
