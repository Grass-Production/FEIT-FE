...
export const getAllQuestionExamByIdExam = async (id) => {
    const res = await get(`http://localhost:8080/api/exercise/question/fetch/exam_id?exam_id=${id}`, {
        headers: {
            "Content-Type": "application/json",
        },
        credentials: "include",
...
export const getAllExam = async () => {
    const res = await get('http://localhost:8080/api/admin/exercise/all/fetch', {
        headers: {
            "Content-Type": "application/json",
        },
        credentials: "include",
